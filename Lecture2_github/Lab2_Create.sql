...
Update the existing records with values for this new column.
b. Modify HireDate Column: Write a SQL statement to modify the `Department`
column in the `EMPLOYEES2` table to be of type `VARCHAR2` with a
maximum length of 30 characters.

15. Movies Table:
a. Add Director Column: Write a SQL statement to add a new column named
`Director` to the `MOVIES` table which can store up to 20 characters.
b. Modify MovieName Column: Write a SQL statement to increase the size of the
`MovieName` column in the `MOVIES` table to allow up to 40 characters. The
current size of the movie name column is 30 characters.

16. Updating Book Price: The bookstore has decided to offer a discount on older books to
encourage sales. Your task is to reduce the price of all books published before the year
2000 by 15%. Write an SQL `UPDATE` statement to reduce the price of all books
published before the year 2000 by 15%. Ensure that the updated prices are rounded to
two decimal places.
...
18. Correcting Name Typographical Errors: A recent data audit revealed that a data entry
operator mistakenly entered &quot;Johhn&quot; instead of &quot;John&quot; in the `FirstName` column. Your
task is to find and correct this error in the `students` table. Write an SQL `UPDATE`
statement to correct the first name &quot;Johhn&quot; to &quot;John&quot; in the `students` table. After
updating, retrieve the rows where the `FirstName` is &quot;John&quot; to confirm the correction.
19. Updating Date of Birth Records: Due to an administrative error, student with ID 505 had
her `DOB` recorded as &quot;1999-04-30&quot;. After cross-checking with paper records, it&#39;s
determined that the correct date of birth for this student should be &quot;2000-04-30&quot;. Write an
SQL `UPDATE` statement to change the `DOB` of the student from &quot;1999-04-30&quot; to
&quot;2000-04-30&quot;. Verify your update by retrieving row for student ID 505.
20. Updating Product Names: The supplier has rebranded one of its products. All instances of
the product named &quot; Smartphone&quot; in the database have been changed to &quot; Smartphone
...
update is complete, retrieve rows with an `OrderDate` of &quot;2023-07-11&quot; to verify your
corrections.
...
in the database. Write an SQL `UPDATE` statement to change the last name &quot;Smithson&quot;
to &quot;Smith&quot; for the affected employee in the `employees` table. After performing the
update, retrieve rows where the `LastName` is &quot;Smith&quot; to verify the change.
23. Adjusting Hire Date: Due to an administrative oversight, all employees who were hired
on &quot;2021-01-15&quot; were mistakenly recorded as being hired on &quot;2021-01-10&quot;. This
discrepancy needs to be corrected. Write an SQL `UPDATE` statement to correct the
`HireDate` for all employees who were wrongly entered as being hired on &quot;2021-01-10&quot;,
changing it to &quot;2021-01-15&quot;. After the update, retrieve rows with a `HireDate` of &quot;2021-
01-15&quot; to verify your corrections.
24. Changing Movie Genres: A change in classification standards means that all movies
previously labeled under the genre &quot;Drama&quot; should now be classified as &quot;Family Drama&quot;.
You need to adjust the database entries to reflect this change. Write an SQL `UPDATE`
statement to modify the genre &quot;Drama&quot; to &quot;Family Drama&quot; in the `movies` table. After
performing the update, retrieve rows where the `Genre` is &quot;Family Drama&quot; to verify the
change.
25. Adjusting Movie Release Year: Due to a miscommunication with your data source, all
movies recorded with a `ReleaseYear` of 2022 were actually released in 2021. You must

Database Systems UNYT

Page 7 of
correct this error in the database. Write an SQL `UPDATE` statement to modify the
`ReleaseYear` for movies wrongly entered as 2022, changing it to 2021. After the update,
retrieve rows with a `ReleaseYear` of 2021 to verify your corrections.
26. Books Table:
a. Find Fantasy Novels: Write a SQL query to retrieve all columns for books whose
titles contain the word &quot;Great&quot;.
b. Books Priced Above $15: Write a SQL query to retrieve the `Title` and `Price` of
all books priced above $15.

27. Students2 Table:
a. Students Born After 1997: Write a SQL query to retrieve the `FirstName`,
`LastName`, and `DOB` of students who were born after January 1, 1997.
b. Search for a Student: Write a SQL query to find all information about a student
named &quot;Jane Smith&quot;.

28. Orders Table:
a. Recent Orders: Write a SQL query to retrieve all columns for orders that were
placed in August 2023.
b. Bulk Orders: Write a SQL query to retrieve the `OrderID` and `Quantity` of
orders where the quantity is more than 5.

29. Employees2 Table:
a. New Hires: Write a SQL query to retrieve the `FirstName` and `HireDate` of
...
30. Movies Table:
a. Sci-Fi Movies Released After 2000: Write a SQL query to retrieve the
`MovieName` and `ReleaseYear` of movies in the &quot;Sci-Fi&quot; genre that were
released after the year 2000.
b. Movies from the &#39;90s: Write a SQL query to retrieve all columns for movies that
were released between 1990 and 1999, inclusive.

31. Books Table:
a. Delete Books by Publication Year: Delete all books from the table that were
published in 1925.
b. Delete Books Below Price: Remove all books from the database that are priced
below $10.
32. Students2 Table:
a. Delete Students by Year of Birth: Remove all students whose year of birth is
1996.
b. Delete Specific Student: Delete the student records for anyone named &quot;Jane
Smith&quot;.
33. Orders Table:
a. Delete Orders by Date: Delete all orders that were placed on &#39;2023-07-15&#39;.
b. Delete Orders with Low Quantity: Remove all orders from the table where the
...
Page 8 of
34. Employees2 Table:
a. Delete Employees by Hiredate: Delete all employees who joined in either 2018 or
2019.
b. Delete Recent Hires: Remove all employees hired after &#39;2023-01-01&#39;.
35. Movies Table:
a. Delete Movies by Release Year: Delete all movies from the table that were
